...
import 'package:socialnetworkapp/screens/profile_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body:isShowUsers? FutureBuilder(
        future: FirebaseFirestore.instance.collection('users').where('username',isGreaterThanOrEqualTo:searchContoller.text ).get(),
